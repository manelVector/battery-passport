...
let imgSource = ""; // Fuente de imagen según dispositivo (PC o móvil)
...
export function renderBESS(id, data) {
  ...
  // -------------------------------------------------------------
  // Mostrar iconos según las etiquetas de cumplimiento
  // (solo si existen los símbolos esperados)
  // -------------------------------------------------------------
  ...
  // Cierre de la sección Compliance Labels
  html += `
        </div>
      </div>
    </div>
  ...
  // =============================================================
  // Selección de la imagen según tipo de dispositivo
  ...
  // =============================================================
  // Imagen interactiva con Battery Packs (BP)
  // Cada área <area> enlaza a un Battery Pack diferente
  // =============================================================
  html += `
  ...
  // Añadir áreas clicables (una por Battery Pack)
  ...
  // Cierre del mapa y del contenedor
  html += `
        </map>
...
// -------------------------------------------------------------
// Devuelve las coordenadas (coords) de cada Battery Pack
// en la imagen interactiva, dependiendo del tipo de imagen.
// =============================================================
...
function getBPcoords(index) {
  ...
  // Devuelve las coordenadas si existen o un valor neutro
