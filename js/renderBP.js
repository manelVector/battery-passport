...
export function renderBP(id, data) {
    ...
    `<div class="frame">
      ...
      <div class="frame">
        ...
        <div class="accordion">
          <div class="accordion-title">Performance and Durability</div>
          <div class="accordion-content">
              <div class="row"><div class="label">Rated Capacity:</div><div class="value">${data.performance_and_durability.capacity.rated_capacity}</div></div>
              ...
              <div class="row"><div class="label">Maximum Permitted Battery Power:</div><div class="value">${data.performance_and_durability.voltage_and_power.maximum_permitted_battery_power}</div></div>
              <div class="row"><div class="label">Expected Calendar Life:</div><div class="value">${data.performance_and_durability.lifetime.expected_calendar_life_years}</div></div>
              <div class="row"><div class="label">Expected Cycle Life:</div><div class="value">${data.performance_and_durability.lifetime.expected_cycle_life}</div></div>
              <div class="row"><div class="label">Cycle Life Reference Test:</div><div class="value">${data.performance_and_durability.lifetime.cycle_life_reference_test}</div></div>
              <div class="row"><div class="label">C-Rate Cycle Life Test:</div><div class="value">${data.performance_and_durability.lifetime.c_rate_cycle_life_test}</div></div>
              ...
              <div class="row"><div class="label">Temp Lower Boundary:</div><div class="value">${data.performance_and_durability.temperature_and_throughput.temperature_idle_range.lower_boundary}</div></div>
              <div class="row"><div class="label">Temp Upper Boundary:</div><div class="value">${data.performance_and_durability.temperature_and_throughput.temperature_idle_range.upper_boundary}</div></div>
          </div>
        </div>
      </div>
