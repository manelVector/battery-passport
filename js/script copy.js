          ...
          <div class="accordion">
            <div class="accordion-title">General Information</div>
              <div class="accordion-content">
                ...
                <map name="image-map">
                    <area target="" alt="BP1" title="BP1" href="index.html?id=${item.batpacks[0]}" coords="105,80,542,296" shape="rect">
                    <area target="" alt="BP2" title="BP2" href="index.html?id=${item.batpacks[0]}" coords="109,340,537,557" shape="rect">
                    <area target="" alt="BP3" title="BP3" href="index.html?id=${item.batpacks[0]}" coords="110,604,534,828" shape="rect">
                    <area target="" alt="BP4" title="BP4" href="index.html?id=${item.batpacks[0]}" coords="112,869,533,1092" shape="rect">
                    <area target="" alt="BP5" title="BP5" href="index.html?id=${item.batpacks[0]}" coords="112,1138,537,1360" shape="rect">
                    <area target="" alt="BP6" title="BP6" href="index.html?id=${item.batpacks[0]}" coords="108,1400,534,1623" shape="rect">
                    <area target="" alt="BP7" title="BP7" href="index.html?id=${item.batpacks[0]}" coords="105,1668,534,1890" shape="rect">
                    <area target="" alt="BP8" title="BP8" href="index.html?id=${item.batpacks[0]}" coords="638,74,1066,299" shape="rect">
                    <area target="" alt="BP9" title="BP9" href="index.html?id=${item.batpacks[0]}" coords="637,338,1066,561" shape="rect">
                    <area target="" alt="BP10" title="BP10" href="index.html?id=${item.batpacks[0]}" coords="637,607,1070,828" shape="rect">
                    <area target="" alt="BP11" title="BP11" href="index.html?id=${item.batpacks[0]}" coords="641,869,1067,1094" shape="rect">
                    <area target="" alt="BP12" title="BP12" href="index.html?id=${item.batpacks[0]}" coords="642,1135,1068,1355" shape="rect">
                    <area target="" alt="BP13" title="BP13" href="index.html?id=${item.batpacks[0]}" coords="642,1403,1060,1624" shape="rect">
                    <area target="" alt="BP14" title="BP14" href="index.html?id=${item.batpacks[0]}" coords="636,1667,1060,1888" shape="rect">
                </map>
